...
twitch_miner = TwitchChannelPointsMiner(
    username="Pixel_Tani",
    password="Krzychu26",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1445919159476293824/E-s5gt8OVU6r7uR4d5gIlhiIKsiJ_S3ZFMGT2Rg_dDDelpZuKH8QYbtL1xIPYyy8EuEO",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION, Events.GAIN_FOR_RAID, Events.GAIN_FOR_CLAIM, Events.GAIN_FOR_WATCH, Events.BONUS_CLAIM, Events.JOIN_RAID],                                  # Only these events will be sent to the chat
        ),
        webhook=Webhook(
...
twitch_miner.mine(
    [
       ...
       Streamer("froggymarivt", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("jungi_", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("chiotails", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       ...
       Streamer("cptcamille", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("rybcia01", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("skaiwolfix", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("lychibewastaken", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("maekaamaya", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("clairaclover", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("synthie_vt", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("hamuchivt", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("morifirewitch", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("azuriteien", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("mambolina", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("vixen_mp2", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("kaffitaru", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("gaiety", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("bluwunk", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("panna_cookie", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("maisiemomo", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )), 
       Streamer("shy_nori", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("the_eggroller", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("samthelemonboy", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("eerithu", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("inkapurinka", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("akiirie", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("pachi", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("curiousjoi", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("sakebinii", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("sunnysplosion", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("laucilka", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("deucel", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("zlemyslisz", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("kmntxd", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("majestic_stone", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("sylvarvt", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("menders_7", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("sigyetaeyeob", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("lady_libris", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("zuan", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("lupisora", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("hira_", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("vulpeshd", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("hoshichaan_", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("aaiza_project", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("OkuriRinVT", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("naberius_lamb", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("blankiexiii", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("snnuy", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("shiyorua", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("sinfulazzy", settings=StreamerSettings(make_predictions=False  , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,      where=Condition.LTE, value=250 ) ) )), 
       Streamer("angela35", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("rinbanana", settings=StreamerSettings(make_predictions=False , follow_raid=True , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART , percentage=5 , stealth_mode=True,  percentage_gap=20 , max_points=234   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_USERS,      where=Condition.LTE, value=250 ) ) )),
       Streamer("meoni", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("dyarikku", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("lawendowa_", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
       Streamer("tieflingmelissa", settings=StreamerSettings(make_predictions=False , follow_raid=True  , claim_drops=False  , watch_streak=True , bet=BetSettings(strategy=Strategy.PERCENTAGE , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=1234  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
